		...
		DateTimePicker.prototype = {
			...
			_modifyPicker: function()
			{
				...
				if(bDisplaySetButton)
					sDTPickerButtons += "<div class='dtpicker-button dtpicker-buttonSet'>" + dtPickerObj.settings.setButtonContent + "</div>";
				if(bDisplayClearButton)
					sDTPickerButtons += "<div class='dtpicker-button dtpicker-buttonClear'>" + dtPickerObj.settings.clearButtonContent + "</div>";
